  ...
  return (
    <>
      <MyNavbar/>
        ...
        <h2 style={{ color: 'blue', fontSize: '24px', marginBottom: '10px' }}>Song file</h2>
        <input
          type="file"
          accept="audio/*"
...
//         {error && errorMsg && <h3 className="headline3">{errorMsg}</h3>}
...
//         <button className="btn-type2" onClick={handleSubmit}>Upload Song</button>
//         {loading && <p className="text"><AiOutlineLoading className="AiOutlineLoading" size={36} /></p>}
//       <Outlet />
//       <Footer/>
//     </>
//   );
